...
export default class QueryHeader extends Component {
  constructor(props, context) {
    ...
    this.state = {
      ...
      modal: null,
      revisions: null,
      isUserHavingSavePermission: false
    };
  }
  ...
  async componentWillMount() {
    const savePermission =  await this._hideAskQuestion();
    this.setState({isUserHavingSavePermission: savePermission})
  }
 ...
 componentWillUnmount() {
  ...
  getHeaderButtons() {
    ...
    if (isNew && isDirty && this.state.isUserHavingSavePermission) {
      buttonSections.push([
        <ModalWithTrigger
          form
          key="save"
